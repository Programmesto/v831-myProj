...
void myProgram() {
	...
	sunxi_ion_loadin((uint32_t*)Placeholder, sizeof(Placeholder), (uint32_t)(gp_paddr)+data_offset);
	data_offset += sizeof(Placeholder);
	printf("%p\n", (uint32_t)(gp_paddr)+data_offset);
	
	uint32_t lava_pad_6 = 1692800; 
	sunxi_ion_loadin((uint32_t*)lava_pad_6, sizeof(lava_pad_6), (uint32_t)(gp_paddr)+data_offset);
	data_offset += sizeof(lava_pad_6);
	printf("%p\n", (uint32_t)(gp_paddr)+data_offset);
	
	uint32_t resnet_v1_50_conv1_weights = 100352; 
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_conv1_weights, sizeof(resnet_v1_50_conv1_weights), (uint32_t)(gp_paddr)+data_offset);
	data_offset += sizeof(resnet_v1_50_conv1_weights);
	printf("%p\n", (uint32_t)(gp_paddr)+data_offset);
	
	uint32_t resnet_v1_50_conv1_BatchNorm_gamma = 256; 
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_conv1_BatchNorm_gamma, sizeof(resnet_v1_50_conv1_BatchNorm_gamma), (uint32_t)(gp_paddr)+data_offset);
	data_offset += sizeof(resnet_v1_50_conv1_BatchNorm_gamma);
	printf("%p\n", (uint32_t)(gp_paddr)+data_offset);
	
	uint32_t resnet_v1_50_conv1_BatchNorm_beta = 256; 
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_conv1_BatchNorm_beta, sizeof(resnet_v1_50_conv1_BatchNorm_beta), (uint32_t)(gp_paddr)+data_offset);
	data_offset += sizeof(resnet_v1_50_conv1_BatchNorm_beta);
	printf("%p\n", (uint32_t)(gp_paddr)+data_offset);
	
	uint32_t resnet_v1_50_conv1_BatchNorm_moving_mean = 256; 
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_conv1_BatchNorm_moving_mean, sizeof(resnet_v1_50_conv1_BatchNorm_moving_mean), (uint32_t)(gp_paddr)+data_offset);
	data_offset += sizeof(resnet_v1_50_conv1_BatchNorm_moving_mean);
	printf("%p\n", (uint32_t)(gp_paddr)+data_offset);
	
	uint32_t resnet_v1_50_conv1_BatchNorm_moving_variance = 256; 
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_conv1_BatchNorm_moving_variance, sizeof(resnet_v1_50_conv1_BatchNorm_moving_variance), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)alu_mul_resnet_v1_50_conv1_BatchNorm_moving_variance, sizeof(alu_mul_resnet_v1_50_conv1_BatchNorm_moving_variance), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv1_weights, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv1_weights), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv1_BatchNorm_gamma, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv1_BatchNorm_gamma), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv1_BatchNorm_beta, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv1_BatchNorm_beta), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv1_BatchNorm_moving_mean, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv1_BatchNorm_moving_mean), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv1_BatchNorm_moving_variance, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv1_BatchNorm_moving_variance), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)alu_mul_resnet_v1_50_block1_unit_1_bottleneck_v1_conv1_BatchNorm_moving_variance, sizeof(alu_mul_resnet_v1_50_block1_unit_1_bottleneck_v1_conv1_BatchNorm_moving_variance), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)lava_conv2d_norm_relu_3, sizeof(lava_conv2d_norm_relu_3), (uint32_t)(gp_paddr)+data_offset);
	data_offset += sizeof(lava_conv2d_norm_relu_3);
	printf("%p\n", (uint32_t)(gp_paddr)+data_offset);
	
	uint32_t resnet_v1_50_block1_unit_1_bottleneck_v1_conv2_weights = 147456; 
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv2_weights, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv2_weights), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv2_BatchNorm_gamma, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv2_BatchNorm_gamma), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv2_BatchNorm_beta, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv2_BatchNorm_beta), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv2_BatchNorm_moving_mean, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv2_BatchNorm_moving_mean), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv2_BatchNorm_moving_variance, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv2_BatchNorm_moving_variance), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)alu_mul_resnet_v1_50_block1_unit_1_bottleneck_v1_conv2_BatchNorm_moving_variance, sizeof(alu_mul_resnet_v1_50_block1_unit_1_bottleneck_v1_conv2_BatchNorm_moving_variance), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)lava_conv2d_norm_5, sizeof(lava_conv2d_norm_5), (uint32_t)(gp_paddr)+data_offset);
	data_offset += sizeof(lava_conv2d_norm_5);
	printf("%p\n", (uint32_t)(gp_paddr)+data_offset);
	
	uint32_t lava_conv2d_norm_relu_4 = 802816; 
	sunxi_ion_loadin((uint32_t*)lava_conv2d_norm_relu_4, sizeof(lava_conv2d_norm_relu_4), (uint32_t)(gp_paddr)+data_offset);
	data_offset += sizeof(lava_conv2d_norm_relu_4);
	printf("%p\n", (uint32_t)(gp_paddr)+data_offset);
	
	uint32_t resnet_v1_50_block1_unit_1_bottleneck_v1_conv3_weights = 65536; 
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv3_weights, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv3_weights), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv3_BatchNorm_gamma, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv3_BatchNorm_gamma), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv3_BatchNorm_beta, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv3_BatchNorm_beta), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv3_BatchNorm_moving_mean, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv3_BatchNorm_moving_mean), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)resnet_v1_50_block1_unit_1_bottleneck_v1_conv3_BatchNorm_moving_variance, sizeof(resnet_v1_50_block1_unit_1_bottleneck_v1_conv3_BatchNorm_moving_variance), (uint32_t)(gp_paddr)+data_offset);
	...
	sunxi_ion_loadin((uint32_t*)alu_mul_resnet_v1_50_block1_unit_1_bottleneck_v1_conv3_BatchNorm_moving_variance, sizeof(alu_mul_resnet_v1_50_block1_unit_1_bottleneck_v1_conv3_BatchNorm_moving_variance), (uint32_t)(gp_paddr)+data_offset);
